...
class _LoginPageState extends State<LoginPage> with TickerProviderStateMixin {
  ...
  static const String baseUrl = 'https://2639557191e6.ngrok-free.app/api/login';
...
Future<void> _handleGoogleLogin() async {
  ...
  final googleLoginUrl = 'https://2639557191e6.ngrok-free.app/auth/google/redirect'; // Ganti dengan ngrok URL kamu
  ...
  try {
    ...
    if (await canLaunchUrl(uri)) {
      ...
      _showErrorSnackBar('Gagal membuka halaman login Google');
    }
  } catch (e) {
    _showErrorSnackBar('Terjadi kesalahan saat membuka login Google');
  } finally {
    setState(() {
      ...
      child: Image.network(
        ...
        errorBuilder: (context, error, stackTrace) {
          ...
          return Container(
            ...
            child: Icon(Icons.g_mobiledata, size: 16, color: Colors.grey[600]),
